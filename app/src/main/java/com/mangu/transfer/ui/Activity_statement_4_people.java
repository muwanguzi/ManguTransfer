...
public class Activity_statement_4_people extends AppCompatActivity {
    private static final String url = Constant.PEOPLESTATEMENT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_people_statement);
        ...
        listView.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> arg0, View view, int position, long arg3) {
                        ...
                        TextView txtamount = view.findViewById(R.id.description);
                        ...
                        dialogButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent = new Intent(Activity_statement_4_people.this, Activity_connect_send_to_many.class);

                                intent.putExtra("USessionID", TransactionID);
                                //intent.putExtra("MoneySenderID", m_senderId);
                                intent.putExtra("Number_Of_Recipients", OrganisationName);
    ...
    public void deleteListItem(final String TransactionID) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.DELETESTPEOPLEITEM,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (mres == 1) {
                                ...
                                Intent intent = new Intent(Activity_statement_4_people.this, Activity_statement_4_people.class);
                                startActivity(intent);
                                finish();
                                Toast.makeText(Activity_statement_4_people.this, msg,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                double amt = Double.valueOf(obj.getString("OverallTotal"));
                                BigDecimal mBigtemp_str = new BigDecimal(amt, MathContext.DECIMAL64);
                                DecimalFormat fmt = new DecimalFormat("#,###.00");
                                String formatedAmt = fmt.format(mBigtemp_str);
                                custom_list_model.setTitle(obj.getString("FirstName"));
                                custom_list_model.setDescription(mForeignCurrencyCode + " " + formatedAmt);
                                custom_list_model.setAdditional_info(obj.getString("DateTransfered"));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                Intent intent = new Intent(Activity_statement_4_people.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
        ...
        if (id == R.id.statement4people) {
            ...
            Intent intent = new Intent(Activity_statement_4_people.this, Activity_charity_statement.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
            finish();
            startActivity(intent);
            overridePendingTransition(R.anim.open_main, R.anim.close_next);
            ...
            Intent intent = new Intent(Activity_statement_4_people.this, Activity_bank_statement.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
            startActivity(intent);
            return true;
