...
public class Activity_connect_send_to_org extends AppCompatActivity {
    WebView webView;
    String final_email = "";
    String transId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONObject json = new Activity_connect_send_to_org.JSONParse().execute().get();
        ...
        webView.loadUrl(Constant.MASTERCARD_API_CHARITY);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                Intent intent = new Intent(Activity_connect_send_to_org.this, Activity_send_to_charity.class);
        ...
        if (id == R.id.statement4people) {
            Intent intent = new Intent(Activity_connect_send_to_org.this, Activity_statement_4_people.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
            overridePendingTransition(R.anim.open_main, R.anim.close_next);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(Activity_connect_send_to_org.this, Activity_charity_statement.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
            overridePendingTransition(R.anim.open_main, R.anim.close_next);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(Activity_connect_send_to_org.this, Activity_bank_statement.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
            overridePendingTransition(R.anim.open_main, R.anim.close_next);
            startActivity(intent);
            finish();
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Activity_connect_send_to_org.this, Activity_charity_project_list.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
        startActivity(intent);
        finish();
        overridePendingTransition(R.anim.open_main, R.anim.close_next);
    ...
    public class JavaScriptAndroidInterface {
        ...
        public void errorMsg() {
            ...
            alertDialog.setMessage("Your transaction has Failed, Please try again");
        ...
        public void transactionMsg() {
            ...
            // Setting Dialog Message
            alertDialog.setMessage("Your transaction has been successful, Receipt has been sent to your email");
            // Setting Positive "Yes" Button
            alertDialog.setPositiveButton("Ok",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {

                            //clear sender id from the shared preferences

                            //Move to Next screen
                            Intent chnIntent = new Intent(Activity_connect_send_to_org.this, Activity_charity_statement.class);
    ...
    private class JSONParse extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Activity_connect_send_to_org.this);
