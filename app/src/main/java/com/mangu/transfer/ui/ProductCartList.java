...
import com.mangu.transfer.adapter.CustomCashListAdapter;
...
public class ProductCartList extends AppCompatActivity {
    ...
    private CustomCashListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomCashListAdapter(this, FarmProjectList);
        ...
        StringRequest cartlist = new StringRequest(Request.Method.POST, Constant.VIEWCARTLIST,
             ...
             1                   adapter.notifyDataSetChanged();*/
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ProductCartList.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.cartlist) {
            Intent intent = new Intent(ProductCartList.this, ProductCartList.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
