...
public class Activity_product_description extends AppCompatActivity {
    ...
    public void payment(final String itempriceid) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://mangumangu.com/json/GetManguProjectDetails.aspx",
...
// ...
                            ...
                            for (int i = 0; i < json.length(); i++) {
                                ...
                                imagenamestr = jObj.getString("img");
                                project_name = jObj.getString("ItemName");
                                project_description = jObj.getString("ShortDescription");
                                amount_needed = jObj.getString("ItemPrice");
                                amount_collected = jObj.getString("ItemPrice");
    ...
    public void addtocart(final String itempriceid, final String Qty) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://mangumangu.com/json/AddManguProjectCart.aspx",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        hideDialog();
                        try {
                            ...
                            if (error > 0) {
                                // Launch main activity
                                Intent intent = new Intent(Activity_product_description.this, DeliveryAddressFragment.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.cart) {
            Intent intent = new Intent(Activity_product_description.this, ProductCartList.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
            overridePendingTransition(R.anim.open_main, R.anim.close_next);
            startActivity(intent);
            return true;
