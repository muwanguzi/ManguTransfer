...
public class CustomListAdapterAvailablepjt extends BaseAdapter

{
    ...
    public CustomListAdapterAvailablepjt(Activity activity, List<Custom_list_model> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.item_row_availablefarm, null);
