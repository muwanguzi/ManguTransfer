...
public class CustomListAdapterMyProjects extends BaseAdapter

{
    ...
    public CustomListAdapterMyProjects(Activity activity, List<Custom_list_model> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.item_row_myprojects, null);
